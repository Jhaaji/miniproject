...
import com.example.rajeevjha.mini.jsonEntityObjects.PaymentResponseObject;
import com.example.rajeevjha.mini.jsonEntityObjects.ServerObject;
...
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    private void initializePayPalPayment(){
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(totalCostPrice)), "BRL", "cart items", PayPalPayment.PAYMENT_INTENT_SALE);
       // PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(totalCostPrice)), "USD", "cart items", PayPalPayment.PAYMENT_INTENT_SALE);
